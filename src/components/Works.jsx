    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute right-0 bottom-0 flex m-3 card-img_hover">
            <div
            ...
            <div
              ...
              className="ml-2 black-gradient w-12 h-12 rounded-full flex justify-center items-center cursor-pointer"
            >
